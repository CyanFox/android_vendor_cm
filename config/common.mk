...
ifeq ($(CM_BUILDTYPE), RELEASE)
    ifndef TARGET_VENDOR_RELEASE_BUILD_ID
        ...
        CF_VERSION := $(PRODUCT_VERSION_MAJOR_CF).$(PRODUCT_VERSION_MINOR_CF).$(PRODUCT_VERSION_MAINTENANCE_CF)$(PRODUCT_VERSION_DEVICE_SPECIFIC)
    else
        ifeq ($(TARGET_BUILD_VARIANT),user)
            CM_VERSION := $(PRODUCT_VERSION_MAJOR).$(PRODUCT_VERSION_MINOR)-$(TARGET_VENDOR_RELEASE_BUILD_ID)-$(CM_BUILD)
            CF_VERSION := $(PRODUCT_VERSION_MAJOR_CF).$(PRODUCT_VERSION_MINOR_CF)-$(TARGET_VENDOR_RELEASE_BUILD_ID)
        else
            CM_VERSION := $(PRODUCT_VERSION_MAJOR).$(PRODUCT_VERSION_MINOR).$(PRODUCT_VERSION_MAINTENANCE)$(PRODUCT_VERSION_DEVICE_SPECIFIC)-$(CM_BUILD)
            CF_VERSION := $(PRODUCT_VERSION_MAJOR_CF).$(PRODUCT_VERSION_MINOR_CF).$(PRODUCT_VERSION_MAINTENANCE_CF)$(PRODUCT_VERSION_DEVICE_SPECIFIC)
        endif
    ...
    CF_VERSION := $(PRODUCT_VERSION_MAJOR_CF).$(PRODUCT_VERSION_MINOR_CF).$(PRODUCT_VERSION_MAINTENANCE_CF)-$(shell date -u +%Y%m%d)-$(CM_BUILDTYPE)$(CM_EXTRAVERSION)
endif
